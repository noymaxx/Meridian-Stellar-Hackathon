...
export const BLEND_TESTNET_IDS = {
  ids: {
    ...
    TestnetV2: "CDDG7DLOWSHRYQ2HWGZEZ4UTR7LPTKFFHN3QUCSZEXOWOPARMONX6T65",
  },
  hashes: {
...
export type BlendTestnetIds = typeof BLEND_TESTNET_IDS;
